...
class Imagenette:
    ...
    def load_dataset(self):
        train_ds = tfds.load(name="imagenette", split="train", as_supervised=True)
        test_ds = tfds.load(name="imagenette", split="validation", as_supervised=True)
    ...
    def _augment(self, images, labels):
        ...
        images = tf.image.resize_with_pad(images, target_height=self.config.img_height+10, target_width=self.config.img_width+10)
